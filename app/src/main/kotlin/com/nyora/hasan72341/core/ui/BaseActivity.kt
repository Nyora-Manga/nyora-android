...
import com.nyora.hasan72341.core.ui.util.FrameRateManager
import com.nyora.hasan72341.core.util.ext.isWebViewUnavailable
...
abstract class BaseActivity<B : ViewBinding> :
	...
	override fun onCreate(savedInstanceState: Bundle?) {
	        ...
	        setTheme(colorScheme.styleResId)

	        if (colorScheme == com.nyora.hasan72341.core.prefs.ColorScheme.MONET || colorScheme == com.nyora.hasan72341.core.prefs.ColorScheme.EXPRESSIVE) {
	        ...
	        if (isAmoledTheme) {
			setTheme(R.style.ThemeOverlay_Nyora_Amoled)
		}
		putDataToExtras(intent)
		exceptionResolver = entryPoint.exceptionResolverFactory.create(this)
		enableEdgeToEdge()
		FrameRateManager.boost(window)
