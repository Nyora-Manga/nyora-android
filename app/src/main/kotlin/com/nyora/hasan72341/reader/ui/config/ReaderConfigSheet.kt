...
import com.nyora.hasan72341.databinding.SheetReaderConfigBinding
import kotlinx.coroutines.launch
import com.nyora.hasan72341.reader.domain.PageLoader
import com.nyora.hasan72341.reader.ui.ReaderViewModel
import com.nyora.hasan72341.reader.ui.ScreenOrientationHelper
...
class ReaderConfigSheet :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageServerDelegate = ImageServerDelegate(
            ...
            mangaSource = viewModel.getMangaOrNull()?.source?.name?.let { com.nyora.hasan72341.core.model.MangaSource(it) },
        )
    }
    ...
    override fun onViewBindingCreated(
        ...
        if (manga != null && settings.isAiTranslateEnabled) {
            binding.switchMangaTranslate.isVisible = true
            binding.switchMangaTranslate.isChecked = settings.isAiTranslateEnabledForManga(manga.id)
            binding.switchMangaTranslate.setOnCheckedChangeListener { _, isChecked ->
                settings.setAiTranslateEnabledForManga(manga.id, isChecked)
