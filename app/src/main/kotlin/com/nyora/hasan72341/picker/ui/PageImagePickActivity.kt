...
import com.nyora.hasan72341.picker.ui.manga.MangaPickerFragment
import com.nyora.hasan72341.picker.ui.page.PagePickerFragment
...
class PageImagePickActivity : BaseActivity<ActivityPickerBinding>(),
	...
	fun onMangaPicked(manga: Manga) {
		val args = Bundle(1)
		args.putLong(AppRouter.KEY_ID, manga.id.toLongOrNull() ?: 0L)
