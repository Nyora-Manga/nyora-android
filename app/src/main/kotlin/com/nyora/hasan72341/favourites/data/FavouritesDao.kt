...
abstract class FavouritesDao : MangaQueryBuilder.ConditionCallback {
	...
	abstract suspend fun findCategoriesCount(mangaId: String): Int
	...
	suspend fun delete(mangaId: String) = setDeletedAt(
		mangaId = mangaId,
		deletedAt = System.currentTimeMillis(),
	)

	suspend fun delete(mangaId: String, categoryId: Long) = setDeletedAt(
	...
	suspend fun recover(mangaId: String) = setDeletedAt(
		mangaId = mangaId,
		deletedAt = 0L,
	)

	suspend fun recover(categoryId: Long, mangaId: String) = setDeletedAt(
		categoryId = categoryId,
		mangaId = mangaId,
		deletedAt = 0L,
	)
	...
	protected abstract suspend fun setDeletedAt(categoryId: Long, mangaId: String, deletedAt: Long)
