...
class FavouriteCategoriesActivity :
	...
	override fun onItemClick(item: FavouriteCategory?, view: View) {
		...
		if (selectionController.onItemClick(item.id.toString())) {
			return
		}
	...
	override fun onItemLongClick(item: FavouriteCategory?, view: View): Boolean {
		return item != null && selectionController.onItemLongClick(view, item.id.toString())
	}

	override fun onItemContextClick(item: FavouriteCategory?, view: View): Boolean {
		return item != null && selectionController.onItemContextClick(view, item.id.toString())
	}
