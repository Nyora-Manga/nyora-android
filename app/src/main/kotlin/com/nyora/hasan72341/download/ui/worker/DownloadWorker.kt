...
import com.nyora.hasan72341.core.util.Throttler
import com.nyora.hasan72341.core.util.ext.MimeType
import com.nyora.hasan72341.core.util.ext.awaitFinishedWorkInfosByTag
import com.nyora.hasan72341.core.util.ext.awaitUpdateWork
import com.nyora.hasan72341.core.util.ext.awaitWorkInfosByTag
import com.nyora.hasan72341.core.util.ext.deleteAwait
import com.nyora.hasan72341.core.util.ext.deleteWork
import com.nyora.hasan72341.core.util.ext.deleteWorks
import com.nyora.hasan72341.core.util.ext.ensureSuccess
import com.nyora.hasan72341.core.util.ext.getDisplayMessage
import com.nyora.hasan72341.core.util.ext.getWorkInputData
import com.nyora.hasan72341.core.util.ext.getWorkSpec
...
import com.nyora.hasan72341.core.util.ext.withTicker
import com.nyora.hasan72341.core.util.ext.writeAllCancellable
import com.nyora.hasan72341.core.util.progress.RealtimeEtaEstimator
import com.nyora.hasan72341.download.domain.DownloadProgress
import com.nyora.hasan72341.download.domain.DownloadState
...
import com.nyora.hasan72341.local.data.TempFileFilter
import com.nyora.hasan72341.local.data.input.LocalMangaParser
import com.nyora.hasan72341.local.data.output.LocalMangaOutput
import com.nyora.hasan72341.local.domain.MangaLock
...
class DownloadWorker @AssistedInject constructor(
	...
	private suspend fun getDoneChapters(manga: Manga): Set<String> = runCatchingCancellable {
